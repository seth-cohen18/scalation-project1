...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `example_AutoMPG_Correlation` main function performs correlation analysis on
 *  the UCI AutoMPG dataset.
 *  @see archive.ics.uci.edu/ml/datasets/Auto+MPG
 *  > runMain scalation.modeling.example_AutoMPG_Correlation
 */
@main def example_AutoMPG_Correlation (): Unit =
...
end example_AutoMPG_Correlation


//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `example_AutoMPG_NullModel` main function performs `NullModel` on the UCI AutoMPG
 *  dataset.
 *  @see archive.ics.uci.edu/ml/datasets/Auto+MPG
 *  > runMain scalation.modeling.example_AutoMPG_NullModel
 */
@main def example_AutoMPG_NullModel (): Unit =
    ...
    val e  = y - yp                                                    // error/residual vector
    println (s"error e = $e")

    new Plot (null, y, yp, "NullModel")
    new Plot (null, e, null, "NullModel error")

end example_AutoMPG_NullModel


//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `example_AutoMPG_SimplerRegression` main function performs `SimplerRegression`
 *  on the UCI AutoMPG dataset.
 *  @see archive.ics.uci.edu/ml/datasets/Auto+MPG
 *  > runMain scalation.modeling.example_AutoMPG_SimplerRegression
 */
@main def example_AutoMPG_SimplerRegression (): Unit =
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `example_AutoMPG_SimpleRegression` main function performs `SimpleRegression`
 *  on the UCI AutoMPG dataset.
 *  @see archive.ics.uci.edu/ml/datasets/Auto+MPG
 *  > runMain scalation.modeling.example_AutoMPG_SimpleRegression
 */
@main def example_AutoMPG_SimpleRegression (): Unit =
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `example_AutoMPG_Regression` main function performs `Regression` on the UCI
 *  AutoMPG dataset.
 *  @see archive.ics.uci.edu/ml/datasets/Auto+MPG

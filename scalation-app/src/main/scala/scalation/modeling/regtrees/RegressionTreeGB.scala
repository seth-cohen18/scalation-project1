...
class RegressionTreeGB (x: MatrixD, y: VectorD, fname_ : Array [String] = null,
    ...
    private val forest = new VEC [REG_TREE] ()                                // forest is a list of regression trees
...
//  mod.printTree ()                                                  // print the regression tree
    ...
    for tech <- SelectionTech.values do
        ...
        new PlotM (null, rSq, Regression.metrics, s"R^2 vs n for Regression Tree GB with $tech", lines = true)

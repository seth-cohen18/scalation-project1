...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `TransformerEnc` object implements the attention method based on the
 *  scaled dot product.
 */
object TransformerEnc:

    private val debug = debugf ("TransformerEnc", true)        // debug function
     ...
     */
    def layerNorm (x: MatrixD): MatrixD = 
        val xt = x.ᵀ
        ((xt - xt.mean) / (xt.stdev + eps)).ᵀ
    end layerNorm

end TransformerEnc

import TransformerEnc._

//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `transformerEnc1` main function illustrates the calculation of attention (Q, K, V)
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `transformerEnc2` main function illustrates the steps in an "Encoder-Only Transformer"
 ...
 */
@main def transformerEnc2 (): Unit =

    import neuralnet.SimpleCNN.{y => yy}                      // example univariate time series of length 20 (t = 0 ... 19)
...
//  val z  = f_geLU.fM (u)                                    // hidden matrix from f0 = geLU activation
    ...
    //-------------------------------
    // Prediction Head: Horizon = 1 |
    //-------------------------------

    val h_last = x(x.dim-1)                                   // use the last patch for prediction (simple example)
    println (s"h_last.dim = ${h_last.dim}")                  

    val w_out = VectorD.fill (d_k)(0.1)                       // weight for the prediction head
    val b_out = 0.0                                           // bias for the prediction head

...
class ARX_Quad_D (x: MatrixD, y: MatrixD, hh: Int, n_exo: Int, fname: Array [String] = null,
    ...
    private val debug = debugf ("ARX_Quad_D", false)                       // debug function
...
@main def aRX_Quad_DTest (): Unit =
    ...
    val mod = ARX_Quad_D (EMPTY_EXO, y, hh)                             // create model for time series data
...
//      val mod = ARX_Quad_D (xe, y, hh)                                // create model for time series data
        val mod = ARX_Quad_D.rescale (xe, y, hh, tFormT = Log1p)
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `aRX_Quad_DTest5` main function tests the `ARX_Quad_D` class on real data:
 *  Forecasting COVID-19 using In-Sample Testing (In-ST).
 *  Test forecasts (h = 1 to hh steps ahead forecasts).
